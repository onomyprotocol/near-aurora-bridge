...
bash /nab/tests/container-scripts/setup-validators.sh $NODES

bash /nab/tests/container-scripts/run-testnet.sh $NODES $TEST_TYPE $ALCHEMY_ID &
...
bash /nab/tests/container-scripts/integration-tests.sh $NODES $TEST_TYPE