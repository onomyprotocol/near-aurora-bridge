...
import (
	...
	"github.com/onomyprotocol/near-aurora-bridge/module/app"
	"github.com/onomyprotocol/near-aurora-bridge/module/app/params"
)
...
func createSimappAndExport(
	...
	var nab *app.Nab
	if height != -1 {
		nab = app.NewNabApp(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), encCfg, appOpts)

		if err := nab.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		nab = app.NewNabApp(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), encCfg, appOpts)
	}

	return nab.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
