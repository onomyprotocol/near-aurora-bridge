...
func TestHandleMsgSendToEth(t *testing.T) {
	var (
		...
		denom                           = "nab0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e"
...
func TestMsgSendToCosmosClaimSingleValidator(t *testing.T) {
	...
	assert.Equal(t, sdk.Coins{sdk.NewCoin("nab0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e", amountA)}, balance)
	...
	require.NoError(t, err)
	balance = input.BankKeeper.GetAllBalances(ctx, myCosmosAddr)
	assert.Equal(t, sdk.Coins{sdk.NewCoin("nab0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e", amountB)}, balance)
}
...
func TestMsgSendToCosmosClaimsMultiValidator(t *testing.T) {
	...
	assert.NotEqual(t, sdk.Coins{sdk.NewInt64Coin("nab0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e", 12)}, balance1)
	...
	assert.Equal(t, sdk.Coins{sdk.NewInt64Coin("nab0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e", 12)}, balance2)
	...
	assert.Equal(t, sdk.Coins{sdk.NewInt64Coin("nab0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e", 12)}, balance3)
}
